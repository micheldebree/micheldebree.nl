...
This tune was made on the [Commodore 64](/tags/c64/) home computer somewhere in
1996. Although there were plenty of music editors to create music in by that
time, I chose a very arcane way of doing things; by using assembler code.

The reason to do it like this is because I was after the specific sound of the
excellent music routine by [Laxity](https://csdb.dk/scener/?id=677), and also to
...
Here's the source code for the tune, converted from [Turbo Assembler
(c64)](https://csdb.dk/release/?id=10700) to [Kickassembler
(cross-platform)](http://www.theweb.dk/KickAssembler). The assembler code is the
same, the only differences are the syntax of higher-level constructions like
